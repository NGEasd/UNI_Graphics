...
namespace GrafikaSzeminarium
{
    internal class ModelObjectDescriptor:IDisposable
    {
        ...
        private static readonly float[] red = new float[] {
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
        ...
        private static readonly float[] blue = new float[] {
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
        ...
        private static readonly float[] yellow = new float[] {
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
        ...
        private static readonly float[] orange = new float[] {
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
        ...
        private static readonly float[] purple = new float[] {
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
                1.0f, 0.0f, 0.0f, 1.0f,
        ...
        public ModelObjectDescriptor CreateColoredCube(GL gl, string colorType)
        {
            ...
            ModelObjectDescriptor cube = ModelObjectDescriptor.CreateCube(gl);
            return cube;
        }
        ...
        public void setColorArray(string type)
        {
            switch (type)
            {
                case "RED":
                    ...
                    break;
                case "GREEN":
                    Array.Copy(green, colorArray, green.Length);
                    break;
                case "BLUE":
                    Array.Copy(blue, colorArray, blue.Length);
                    break;
                case "YELLOW":
                    Array.Copy(yellow, colorArray, yellow.Length);
                    break;
                case "ORANGE":
                    Array.Copy(orange, colorArray, orange.Length);
                    break;
                case "PURPLE":
            ...
            Console.WriteLine("Color channged!");
        }
