...
namespace GrafikaSzeminarium
{
    internal class Program
    {
        ...
        private static ModelObjectDescriptor upperCube;
        ...
        private static void GraphicWindow_Load()
        {
            ...
            upperCube = ModelObjectDescriptor.CreateCube(Gl);
        ...
        private static unsafe void GraphicWindow_Render(double deltaTime)
        {
            ...
            {
                cube.Dispose();
                cube = cube.CreateColoredCube(Gl, colors[selectedColorIndex]);
                Console.WriteLine(colors[selectedColorIndex]);
            }
